...
//go:generate swagger generate server --target ../../src --name ResolverDriver --spec ../../api/swagger.yml

func configureFlags(api *operations.ResolverDriverAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ResolverDriverAPI) http.Handler {
